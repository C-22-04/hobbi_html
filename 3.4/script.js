...
let x = checkInteger(10);
let y = checkInteger(10.5);
let z = checkInteger(11);
output.innerHTML += "<p>3. Число 10 =" + x + "</p>";
output.innerHTML += "<p>Число 10.5 =" + y + "</p>";
output.innerHTML += "<p>Число 11 =" + z + "</p>";